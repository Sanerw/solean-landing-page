<script lang="ts" module>
	...
	export const fieldVariants = tv({
		// The fill token is only safe on white or gold; body text needs the darker
		// destructive-text pairing to clear 4.5:1 on the warm ground. See design-system.md 1a.
		base: "gap-3 data-[invalid=true]:text-destructive-text group/field flex w-full",
		variants: {
			orientation: {
