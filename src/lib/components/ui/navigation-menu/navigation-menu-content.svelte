...
<!-- The dropdown panel is always the neutral popover surface, regardless of which
     header variant the trigger sits on, matching Select and Dialog's own popovers. -->
<NavigationMenuPrimitive.Content
	bind:ref
	data-slot="navigation-menu-content"
	class={cn(
		"p-3 ease-[cubic-bezier(0.22,1,0.36,1)]",
		"group-data-[viewport=false]/navigation-menu:rounded-[20px] group-data-[viewport=false]/navigation-menu:border group-data-[viewport=false]/navigation-menu:border-border group-data-[viewport=false]/navigation-menu:bg-background group-data-[viewport=false]/navigation-menu:text-popover-foreground group-data-[viewport=false]/navigation-menu:shadow-[0_12px_32px_rgba(7,26,16,0.19)] group-data-[viewport=false]/navigation-menu:duration-300",
		...
		"top-0 left-0 w-full group-data-[viewport=false]/navigation-menu:top-full group-data-[viewport=false]/navigation-menu:mt-1.5 group-data-[viewport=false]/navigation-menu:overflow-hidden",
