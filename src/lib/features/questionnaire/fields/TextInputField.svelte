<script lang="ts">
	...
	/** The e-mail is the one here that deserves a keyboard of its own. */
	...
	/**
	 * The artboard shows every box on this screen holding an example. The e-mail has one drawn;
	 * the two names do not, so they echo their own label rather than inventing a person, which
	 * would put a made-up name in front of somebody about to type their own.
	 */
