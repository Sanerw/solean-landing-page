 ...
 *
 * **Nothing here is persisted.** The answers and the submitted anamnesis uid live in this
 * module and nowhere else, so a reload starts the questionnaire over: the
...
class QuestionnaireSession {
	...
	/**
	 * Whether the visitor has moved off a step themselves. False on every fresh load, which is
	 * what sends a reload back to the first question rather than to the first unanswered one.
	 */
	get started(): boolean {
		this.revision;
